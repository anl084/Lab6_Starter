...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		// A1. Attach the shadow DOM (open mode so JS/CSS can access it)
		...
		// A4. Insert the styles from cardTemplate.html (copy/paste your CSS inside the backticks)
		style.textContent = `
			* {
		...
		this.shadowElement.append(style, article);
	}
	...
	set data(data) {
		...
		const article = this.shadowElement.querySelector("article");
